    ...
    <div class="container-md d-flex align-items-center justify-content-center flex-column">
      <div class="container-fluid">
        <div id="directory_link" class="p-3 rounded-4 bg-dark-subtle ">
          ...
          <a href="search_residents.php" class="text-decoration-none text-black-50">/ Search Residents</a>
        </div>
        ...
        <form class="d-flex gap-2" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="GET">
          <input class="form-control" name="search" id="search" type="text" placeholder="Search by name or type (*) to see all entries..." style="border: 1px solid gray" />
            ...
            <tbody class="table-group-divider">
              ...
              if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo '<td>   <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailModal' . $row['id'] . '"> View Details </button> </td>';
                    ...
                    <div class='modal-dialog modal-dialog-centered'>
                      <div class='modal-content'>
                        <div class='modal-header'>
                          <h5 class='modal-title' id='modalTitleId'>Name:
                            <span class='text-danger'>{$row['first_name']} {$row['middle_name']} {$row['last_name']}</span>
                          </h5>
                        ...
                        <div class='modal-footer'>
                          ...
                          <a href='update_res.php?from=searchRes&id={$row['id']}' type='button' class='btn btn-primary'>Edit</a>
                        </div>
                      </div>
                    </div>
                  </div>";
      ...
      <!-- Show results after click search -->
      <script>
