...
<head>
  ...
  <title>View Certificate Details</title>
</head>
  ...
  <div class="min-vh-100 p-3" style="width: 83%">
    <div class="w-100">
      <div id="directory_link" class="p-3 rounded-4 bg-dark-subtle ">
        ...
        <a href="view_certificates.php" class="text-decoration-none text-danger">/ View Certificates</a>
        <a href="view_certificate_details.php" class="text-decoration-none text-black-50">/ View Certificate Details</a>
      </div>
      <div class="d-flex align-items-center justify-content-between  gap-2 w-100">

        <h1 class="m-0 text-danger">Certificate Details</h1>
        <a href="view_certificates.php" class="btn btn-danger">Go Back</a>
      </div>
      <div class="table-responsive w-100 my-3 " id="main_table">
        <table align="center" cellpadding="10" border="1" class="table table-dark table-striped table-hover table-bordered text-center align-middle">
          <thead class="table-secondary">
            <tr>
              <th colspan="2">Certificate Details: <span class="text-danger"><?php echo strtoupper($row['resident_name']) ?></span></th>
            </tr>
            <tr>
          ...
          <tbody class="table-group-divider">
            ...
            echo "<tr>", "<td class='fw-bold'> Certificate Type </td>", "<td> {$row['certificate_type']} </td>", "</tr>";
      ...
      <div>
        <a name="" id="" class="btn btn-danger" href="update_certificate.php?id=<?php echo $id; ?>" role="button">Edit</a>
        <button class="btn btn-primary" OnClick="CallPrint(this.value)" id="printBtn"> Print </button>
        <a name="" id="" class="btn btn-dark" href="view_certificates.php" role="button">Back</a>
      </div>
