...
<body class="d-flex">
  ...
  <div class="min-vh-100 pt-3" style="width: 83%">
    <div id="directory_link" class="p-3 rounded-4 mx-3 bg-dark-subtle ">
      ...
      <a href="update_res.php?id=<?php echo $row['id'] ?>" class="text-decoration-none text-black-50">/ Update Resident</a>
    </div>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" class="w-100" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="mb-4 col-md-4">
            ...
            <input type="text" class="form-control" name="first_name" id="first_name" placeholder="" required="true" value="<?php echo $row['first_name']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="middle_name" class="form-label">Middle Name</label>
            <input type="text" class="form-control" name="middle_name" id="middle_name" placeholder="" required="true" value="<?php echo $row['middle_name']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="last_name" class="form-label">Last Name</label>
            <input type="text" class="form-control" name="last_name" id="last_name" placeholder="" required="true" value="<?php echo $row['last_name']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="nick_name" class="form-label">Nick Name</label>
            <input type="text" class="form-control" name="nick_name" id="nick_name" placeholder="" required="true" value="<?php echo $row['nick_name']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
          ...
          <div class="mb-4 col-md-4">
            ...
            <input type="date" class="form-control" name="birth_date" id="birth_date" placeholder="" required="true" value="<?php echo $row['birth_date']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="place_of_birth" class="form-label">Place of Birth</label>
            <input type="text" class="form-control" name="place_of_birth" id="place_of_birth" placeholder="" required="true" value="<?php echo $row['place_of_birth']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
          ...
          <div class="mb-4 col-md-4">
            ...
            <input type="text" class="form-control" name="occupation" id="occupation" placeholder="" required="true" value="<?php echo $row['occupation']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="religion" class="form-label">Religion</label>
            <input type="text" class="form-control" name="religion" id="religion" placeholder="" required="true" value="<?php echo $row['religion']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="lot" class="form-label">Lot</label>
            <input type="text" class="form-control" name="lot" id="lot" placeholder="" required="true" value="<?php echo $row['lot']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="purok" class="form-label">Purok</label>
            <input type="text" class="form-control" name="purok" id="purok" placeholder="" required="true" value="<?php echo $row['purok']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="resident_status" class="form-label">Resident Status</label>
            <input type="text" class="form-control" name="resident_status" id="resident_status" placeholder="" required="true" value="<?php echo $row['resident_status']; ?>" s />
          </div>
          <div class="mb-4 col-md-4">
          ...
          <div class="mb-4 col-md-4">
            ...
            <input type="email" class="form-control" name="email" id="email" placeholder="" required="true" value="<?php echo $row['email']; ?>" />
          </div>
          <div class="mb-4 col-md-4">
            <label for="phone_number" class="form-label">Phone Number</label>
            <input type="text" class="form-control" id="phone_number" name="phone_number" value="<?php echo $row['phone_number']; ?>" required="true" onkeypress="return /[0-9]/i.test(event.key)" pattern="[0-9]+">

          </div>
          <div class="mb-4 col-md-4">
            <label for="telephone_number" class="form-label">Telephone Number</label>
            <input type="text" class="form-control" name="telephone_number" id="telephone_number" value="<?php echo $row['telephone']; ?>" required="true" onkeypress="return /[0-9]/i.test(event.key)" pattern="[0-9]+" />
          </div>
        </div>
        ...
        <div class="text-center pt-3" style="border-top: 1px solid gray">
          ...
          <a class="btn btn-danger" onclick='return aler()' href="delete_resident.php?id=<?php echo $row['id'] ?>" role="button">Delete Resident</a>
